    ...
    <div class="before-footer-wrapper companies-logo-wrapper">
        <div class="container">
            ...
            <div class="row company-logos-bottom">
                ...
                <div class="col-xs-5ths company-logo-single company-dpd">
    ...
    <script>
        $( document ).ready(function() {
            if ( !!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/)) {
                $(".footer-parent").style("background", "linear-gradient(to top right, #eae9e9 50%, transparent 50%) no-repeat top, linear-gradient(0deg, #eae9e9, #eae9e9) no-repeat bottom)");
            }
        });
    </script>
</html>
