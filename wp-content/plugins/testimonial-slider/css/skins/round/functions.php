<?php 
function testimonial_post_processor_round( $posts, $testimonial_slider_curr,$out_echo,$set,$data=array() ){
	$skin='round';
	...
	foreach($posts as $post) {
		...
		$html .= '<div class="testimonial_slideri" '.$testimonial_slider_css['testimonial_slideri'].'>
			<!-- testimonial_slideri --><div class="testimonial_outer_wrap" '.$testimonial_slider_css['testimonial_outer_wrap'].'>';
		...
		$testimonial_by_wrap='<div class="testimonial_avatar_wrap" '.$testimonial_slider_css['testimonial_avatar_wrap'].'><span class="testimonial_avatar" '.$testimonial_slider_css['testimonial_avatar'].'><img src="'.$_testimonial_avatar.'" '.$testimonial_slider_css['testimonial_avatar_img'].' alt="' . esc_attr( strip_tags( $_testimonial_by ) ) . '"  /></span></div><div class="testimonial_by_wrap" '.$testimonial_slider_css['testimonial_by_wrap'].'><div class="testimonial_by_text"><span class="testimonial_by" '.$testimonial_slider_css['testimonial_by'].'>'.$_testimonial_by.'</span>';
                // Star Rating
		$_testimonial_star=get_post_meta($post_id, '_testimonial_star', true);
			...
			$content.="<div class='testimonial-star-outer'>";
			for($i = 0; $i < $_testimonial_star; $i++ ) {
				$content.="<div class='dashicons dashicons-star-filled' ".$testimonial_slider_css['dashicons-star-filled']." ></div>";
			}
			$content.="</div>";
		}
                
                $testimonial_by_wrap .= $content . '<span class="testimonial_site" '.$testimonial_slider_css['testimonial_site_a'].'>'.$testimonial_company.'</span></div></div>';
		...
		$testimonial_quote='<div class="testimonial_content_wrap" ><div class="testimonial_content" '.$testimonial_slider_css['testimonial_quote'].'>'.$slider_excerpt.$read_more;
		/*
                // Star Rating
		$_testimonial_star=get_post_meta($post_id, '_testimonial_star', true);
		if(isset($testimonial_slider_curr['show_star']) && $testimonial_slider_curr['show_star'] == 1 && $_testimonial_star != '' && $_testimonial_star > 0 ) {
		...
		$html .= '<div class="sldr_clearlt"></div><div class="sldr_clearrt"></div></div><!-- End Outer Wrap--><!-- /testimonial_slideri -->
		</div>'; 
	}
...
function testimonial_slider_get_round($slider_handle,$r_array,$testimonial_slider_curr,$set,$echo='1',$data=array()){
	$skin='round';
	global $testimonial_slider,$default_testimonial_slider_settings;
